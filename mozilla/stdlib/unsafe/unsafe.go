...
// Package unsafe provides wrapper of standard library unsafe package to be imported natively in mozilla.
package unsafe
...
func init() {
	Symbols["mozilla/stdlib/unsafe/unsafe"] = map[string]reflect.Value{
		"Symbols": reflect.ValueOf(Symbols),
	}
	Symbols["mozilla/mozilla"] = map[string]reflect.Value{
