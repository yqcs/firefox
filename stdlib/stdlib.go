...
// Package stdlib provides wrappers of standard library packages to be imported natively in mozilla.
package stdlib
...
func init() {
	Symbols["mozilla/stdlib/stdlib"] = map[string]reflect.Value{
